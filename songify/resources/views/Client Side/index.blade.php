	 ...
	 <section class="subscription-section spad">
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-6">
					<ul class="sub-list">
						<li><img src="Client/img/icons/check-icon.png" alt="">Play any track</li>
						<li><img src="Client/img/icons/check-icon.png" alt="">Listen offline</li>
						<li><img src="Client/img/icons/check-icon.png" alt="">No ad interruptions</li>
						<li><img src="Client/img/icons/check-icon.png" alt="">Unlimited skips</li>
						<li><img src="Client/img/icons/check-icon.png" alt="">High quality audio</li>

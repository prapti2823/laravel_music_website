...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      {{-- <a href = "#"><button class ="btn" style="border-radius:18cm; padding-top:10px; margin:5px; width:100px; background-color: black; color:white; "><h6>Sign Up</h6></button>&nbsp;</a>
      <a href="#"><button class ="btn" style="border-radius:18cm; padding-top:10px; margin:5px; width:100px; background-color: black; color: white; "><h6>Login</h6></button></a> --}}
